...
#import "CBRecentUpdatesViewController.h"
#import "CBFavoriteUpdatesViewController.h"


@interface CBRecentUpdatesViewController ()
@end

@implementation CBRecentUpdatesViewController 
...
- (void) setupDataSource {
    ...
    dataSource.query = [CBLIUpdate queryRecentUpdatesInDatabase: app.database].asLiveQuery;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSError *e;
    [update save:&e];
    NSLog(@"fav rev %@ %@", [update.document documentID],[update.document currentRevisionID]);
